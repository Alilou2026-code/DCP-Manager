      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div 
            ...
            className="group bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-4 cursor-pointer hover:border-emerald-500 transition-all"
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">IntuiDCP Manager</h3>
          ...
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">Tableau de bord & Stats</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
          ...
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">Paramètres & Base</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
